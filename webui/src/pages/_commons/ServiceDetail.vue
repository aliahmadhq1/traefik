<template>
  <page-default>
    <section v-if="!loading" class="app-section">
      <div
        class="app-section-wrap app-boxed app-boxed-xl q-pl-md q-pr-md q-pt-xl q-pb-lg"
      >
        <div
          v-if="serviceByName.item"
          class="row no-wrap items-center app-title"
        >
          <div class="app-title-label" style="font-size: 26px">
    ...
    <section class="app-section">
      <div
        class="app-section-wrap app-boxed app-boxed-xl q-pl-md q-pr-md q-pt-lg q-pb-lg"
      >
        <div v-if="!loading" class="row items-start q-col-gutter-md">
          ...
          <div
            v-if="
              serviceByName.item.loadBalancer &&
              serviceByName.item.loadBalancer.healthCheck
            "
            class="col-12 col-md-4 q-mb-lg path-block"
          >
            <div class="row no-wrap items-center q-mb-lg app-title">
                ...
                <div class="row items-start q-col-gutter-md">
                  <div class="col-12">
                    <panel-servers
                      ...
                      :hasStatus="serviceByName.item.serverStatus"
                    />
                  </div>
                </div>
              </div>
          ...
          <div
            v-if="
              serviceByName.item.weighted &&
              serviceByName.item.weighted.services
            "
            class="col-12 col-md-4 q-mb-lg path-block"
          >
            <div class="row no-wrap items-center q-mb-lg app-title">
          ...
          <div
            v-if="
              serviceByName.item.mirroring &&
              serviceByName.item.mirroring.mirrors
            "
            class="col-12 col-md-4 q-mb-lg path-block"
          >
            <div class="row no-wrap items-center q-mb-lg app-title">
    ...
    <section v-if="!loading && allRouters.length" class="app-section">
      <div
        class="app-section-wrap app-boxed app-boxed-xl q-pl-md q-pr-md q-pt-lg q-pb-xl"
      >
        <div class="row no-wrap items-center q-mb-lg app-title">
...
export default {
  ...
  methods: {
    ...mapActions("http", {
      http_getServiceByName: "getServiceByName",
      http_getRouterByName: "getRouterByName",
    }),
    ...mapActions("tcp", {
      tcp_getServiceByName: "getServiceByName",
      tcp_getRouterByName: "getRouterByName",
    }),
    ...mapActions("udp", {
      udp_getServiceByName: "getServiceByName",
      udp_getRouterByName: "getRouterByName",
    }),
    refreshAll() {

    ...
    <q-card-section>
      <div class="row items-center q-col-gutter-md">
        <div class="col-12 col-sm-6">
          <ChartDoughnut :chartdata="getChartdata()" :options="options" />
        </div>
        <div class="col-12 col-sm-6">
          <q-list>
    ...
    getChartdata() {
      if (
        ...
        return {
          datasets: [
            {
              backgroundColor: [this.$q.dark.isActive ? "#2d2d2d" : "#f2f3f5"],
              borderColor: [this.$q.dark.isActive ? "#1d1d1d" : "#fff"],
              data: [1],
            },
          ],
        };
        ...
        return {
          datasets: [
            {
              backgroundColor: ["#00a697", "#db7d11", "#ff0039"],
              borderColor: [

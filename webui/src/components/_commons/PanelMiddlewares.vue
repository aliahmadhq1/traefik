<template>
  <q-card
    ...
    v-bind:class="[
      ...
      { 'panel-middleware-details-dense': isDense },
    ]"
  >
    <q-scroll-area
        ...
        <q-card-section>
          <div class="row items-start no-wrap">
            <div class="col">
              ...
              <q-chip dense class="app-chip app-chip-purple">
                {{ middleware.type }}
              </q-chip>
            </div>
            <div class="col">
              ...
              <div class="block-right-text">
                <q-avatar class="provider-logo">
                  <q-icon
                    :name="`img:${getProviderLogoPath(middleware.provider)}`"
                  />
                </q-avatar>
          ...
          <div class="row items-start no-wrap">
            <div class="col">
              ...
              <div class="block-right-text">
                ...
                <div
                  v-bind:class="[
                    'block-right-text-label',
                    `block-right-text-label-${middleware.status}`,
                  ]"
                >
        ...
        <q-card-section v-if="protocol === 'http'">
          ...
          <q-card-section v-if="middleware.addPrefix">
            <div class="row items-start no-wrap">
              <div class="col">
                ...
                <q-chip dense class="app-chip app-chip-green">
          ...
          <q-card-section v-if="exData(middleware).realm">
            <div class="row items-start no-wrap">
              <div class="col">
                ...
                <q-chip dense class="app-chip app-chip-warning">
          ...
          <q-card-section v-if="middleware.errors">
            <div class="row items-start no-wrap">
              <div class="col">
                ...
                <q-chip dense class="app-chip app-chip-green app-chip-overflow">
          ...
          <q-card-section v-if="middleware.forwardAuth">
            <div class="row items-start no-wrap">
              <div class="col">
                ...
                <q-chip
                  v-for="(respHeader, key) in exData(middleware)
                    .authResponseHeaders"
                  :key="key"
                  dense
                  class="app-chip app-chip-green"
          ...
          <q-card-section v-if="middleware.forwardAuth">
            <div class="row items-start no-wrap">
              <div class="col">
                ...
                <q-chip
                  v-for="(reqHeader, key) in exData(middleware)
                    .authRequestHeaders"
                  :key="key"
                  dense
                  class="app-chip app-chip-green"
          ...
          <q-card-section v-if="middleware.headers">
            <div class="row items-start no-wrap">
              <div class="col">
                ...
                <boolean-state
                  :value="!!exData(middleware).accessControlAllowCredentials"
                />
              </div>
            </div>
          </q-card-section>
          ...
          <q-card-section v-if="middleware.headers">
            <div class="row items-start no-wrap">
              <div class="col">
                ...
                <q-chip
                  v-for="(val, key) in exData(middleware)
          ...
          <q-card-section v-if="middleware.headers">
            <div class="row items-start no-wrap">
              <div class="col">
                ...
                <boolean-state
                  :value="!!exData(middleware).sslTemporaryRedirect"
                />
              </div>
            </div>
          </q-card-section>
          ...
          <q-card-section v-if="middleware.headers">
            <div class="row items-start no-wrap">
              <div class="col">
                ...
                <boolean-state
                  :value="!!exData(middleware).stsIncludeSubdomains"
                />
              </div>
            </div>
          </q-card-section>
          ...
          <q-card-section v-if="middleware.headers">
            <div class="row items-start no-wrap">
              <div class="col">
                ...
                <boolean-state
                  :value="!!exData(middleware).contentTypeNosniff"
                />
              </div>
            </div>
          </q-card-section>
          ...
          <q-card-section v-if="middleware.ipWhiteList">
            <div class="row items-start">
              ...
              <div
                v-if="
                  exData(middleware).ipStrategy &&
                  exData(middleware).ipStrategy.depth
                "
                class="col-12"
              >
                <q-chip dense class="app-chip app-chip-accent">Depth :</q-chip>
                <q-chip dense class="app-chip app-chip-green">
                  {{ exData(middleware).ipStrategy.depth }}
                </q-chip>
              </div>
              <div
                v-if="
                  exData(middleware).ipStrategy &&
                  exData(middleware).ipStrategy.excludedIPs
                "
                class="col-12"
              >
                <div class="flex">
                  <q-chip dense class="app-chip app-chip-accent">
                    Excluded IPs:
                  </q-chip>
                  <q-chip
                    v-for="(excludedIPs, key) in exData(middleware).ipStrategy
                      .excludedIPs"
                    :key="key"
                    dense
                    class="app-chip app-chip-green"
          ...
          <q-card-section
            v-if="
              exData(middleware).sourceCriterion &&
              exData(middleware).sourceCriterion.ipStrategy
            "
          >
            <div class="row items-start">
              <div class="col-12">
              ...
              >
                <div class="flex">
                  ...
                  <q-chip
                    v-for="(excludedIPs, key) in exData(middleware)
          ...
          <q-card-section
            v-if="exData(middleware) && exData(middleware).sourceCriterion"
          >
            <div class="row items-start no-wrap">
              <div
              ...
              >
                ...
                <boolean-state
                  :value="exData(middleware).sourceCriterion.requestHost"
                />
              </div>
            </div>
          </q-card-section>
          ...
          <q-card-section
            v-if="
              middleware.passTLSClientCert && middleware.passTLSClientCert.info
            "
          >
          ...
          <q-card-section
            v-if="
              ...
              middleware.passTLSClientCert.info &&
              middleware.passTLSClientCert.info.subject
            "
          >
            ...
            <div class="row items-start no-wrap">
              <div class="col">
                ...
                <boolean-state
                  :value="!!exData(middleware).info.subject.country"
                />
              </div>
              <div class="col">
                <div class="text-subtitle2">Province</div>
                <boolean-state
                  :value="!!exData(middleware).info.subject.province"
                />
              </div>
            </div>
          </q-card-section>
          ...
          >
            <div class="row items-start no-wrap">
              <div class="col">
                ...
                <boolean-state
                  :value="!!exData(middleware).info.subject.locality"
                />
              </div>
              <div class="col">
                <div class="text-subtitle2">Organization</div>
                <boolean-state
                  :value="!!exData(middleware).info.subject.organization"
                />
              </div>
            </div>
          </q-card-section>
          ...
          >
            <div class="row items-start no-wrap">
              <div class="col">
                ...
                <boolean-state
                  :value="!!exData(middleware).info.subject.organizationalUnit"
                />
              </div>
              <div class="col">
                <div class="text-subtitle2">Common Name</div>
                <boolean-state
                  :value="!!exData(middleware).info.subject.commonName"
                />
              </div>
            </div>
          </q-card-section>
          ...
          >
            <div class="row items-start no-wrap">
              <div class="col">
                ...
                <boolean-state
                  :value="!!exData(middleware).info.subject.serialNumber"
                />
              </div>
              <div class="col">
                <div class="text-subtitle2">Domain Component</div>
                <boolean-state
                  :value="!!exData(middleware).info.subject.domainComponent"
                />
              </div>
            </div>
          </q-card-section>
          ...
          <q-card-section
            v-if="
              middleware.passTLSClientCert &&
              middleware.passTLSClientCert.info &&
              middleware.passTLSClientCert.info.issuer
            "
          >
            ...
            <div class="row items-start no-wrap">
              <div class="col">
                <div class="text-subtitle2">country</div>
                <boolean-state
                  :value="!!exData(middleware).info.issuer.country"
                />
              </div>
              <div class="col">
                <div class="text-subtitle2">Province</div>
                <boolean-state
                  :value="!!exData(middleware).info.issuer.province"
                />
              </div>
            </div>
          </q-card-section>
          ...
          >
            <div class="row items-start no-wrap">
              <div class="col">
                <div class="text-subtitle2">Locality</div>
                <boolean-state
                  :value="!!exData(middleware).info.issuer.locality"
                />
              </div>
              <div class="col">
                <div class="text-subtitle2">Organization</div>
                <boolean-state
                  :value="!!exData(middleware).info.issuer.organization"
                />
              </div>
            </div>
          </q-card-section>
          ...
          >
            <div class="row items-start no-wrap">
              <div class="col">
                <div class="text-subtitle2">Common Name</div>
                <boolean-state
                  :value="!!exData(middleware).info.issuer.commonName"
                />
              </div>
              <div class="col">
                <div class="text-subtitle2">Serial Number</div>
                <boolean-state
                  :value="!!exData(middleware).info.issuer.serialNumber"
                />
              </div>
            </div>
          </q-card-section>
          ...
          >
            <div class="row items-start no-wrap">
              <div class="col">
                <div class="text-subtitle2">Domain Component</div>
                <boolean-state
                  :value="!!exData(middleware).info.issuer.domainComponent"
                />
              </div>
            </div>
          </q-card-section>

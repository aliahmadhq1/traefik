<template>
  <q-card
    flat
    bordered
    v-bind:class="['panel-services', { 'panel-services-dense': isDense }]"
  >
    <q-scroll-area :thumb-style="appThumbStyle" style="height: 100%">
      <q-card-section>
        <div class="row items-start no-wrap">
          ...
          <div class="col-3">
            <div class="text-subtitle2 text-table" style="text-align: right">
              Percent
            </div>
          </div>
          <div class="col-3">
      ...
      <div v-for="(service, index) in data.mirroring.mirrors" :key="index">
        <q-card-section>
          <div class="row items-center no-wrap">
            <div class="col-6">
              <q-chip dense class="app-chip app-chip-rule app-chip-overflow">
                {{ service.name }}

<template>
  <q-card
    ...
    v-bind:class="[
      ...
      { 'panel-service-details-dense': isDense },
    ]"
  >
    <q-scroll-area :thumb-style="appThumbStyle" style="height: 100%">
            ...
            <div class="block-right-text">
              ...
              <div
                v-bind:class="[
                  ...
                  `block-right-text-label-${data.status}`,
                ]"
              >
      ...
      <q-card-section
        v-if="data.loadBalancer && $route.meta.protocol !== 'tcp'"
      >
        <div class="row items-start no-wrap">
          <div class="col">
      ...
      <q-card-section
        v-if="data.loadBalancer && data.loadBalancer.terminationDelay"
      >
        <div class="row items-start no-wrap">
          <div class="col">
      ...
      <q-card-section
        v-if="data.loadBalancer && data.loadBalancer.proxyProtocol"
      >
        <div class="row items-start no-wrap">
          <div class="col">
